...
import com.ikoro.android.nostr.GeohashMessageHandler
import com.ikoro.android.nostr.GeohashRepository
import com.ikoro.android.nostr.NostrDirectMessageHandler
import com.ikoro.android.nostr.NostrIdentityBridge
import com.ikoro.android.nostr.NostrProtocol
import com.ikoro.android.nostr.NostrRelayManager
import com.ikoro.android.nostr.NostrSubscriptionManager
import com.ikoro.android.nostr.PoWPreferenceManager
import com.ikoro.android.nostr.GeohashAliasRegistry
import com.ikoro.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.ikoro.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.ikoro.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.ikoro.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.ikoro.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.ikoro.android.model.IkoroMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.ikoro.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.ikoro.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.ikoro.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.ikoro.android.model.IkoroMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.ikoro.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.ikoro.android.geohash.ChannelID.Mesh -> {
            ...
            is com.ikoro.android.geohash.ChannelID.Location -> {
