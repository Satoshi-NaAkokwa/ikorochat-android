...
import com.ikoro.android.features.file.FileUtils
 ...
 */
private fun tryOpenFile(context: Context, packet: IkoroFilePacket) {
    try {
        // First try to save to temp file and open
        val tempFile = File.createTempFile("ikoro_", ".${packet.fileName.substringAfterLast(".")}", context.cacheDir)
