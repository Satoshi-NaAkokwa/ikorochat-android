...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    var selectedMessageForSheet by remember { mutableStateOf<IkoroMessage?>(null) }
    ...
    val displayMessages = when {
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.ikoro.android.geohash.ChannelID.Location) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.ikoro.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource(com.ikoro.android.R.string.cd_scroll_to_bottom),
...
private fun ChatFloatingHeader(
    ...
    val locationManager = remember { com.ikoro.android.geohash.LocationChannelManager.getInstance(context) }
...
private fun ChatDialogs(
    ...
    selectedMessageForSheet: IkoroMessage?,
    viewModel: ChatViewModel,
    ...
    if (showDebugSheet) {
        com.ikoro.android.ui.debug.DebugSettingsSheet(
