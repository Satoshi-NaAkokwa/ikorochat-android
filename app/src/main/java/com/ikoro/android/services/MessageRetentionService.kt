...
//
//    suspend fun saveMessage(message: IkoroMessage, forChannel: String) = withContext(Dispatchers.IO) {
...
//    }
//
//    suspend fun loadMessagesForChannel(channel: String): List<IkoroMessage> = withContext(Dispatchers.IO) {
...
//    }
//
//    private fun loadMessagesFromFile(file: File): List<IkoroMessage> {
//        if (!file.exists()) {
//            return emptyList()
//        }
//
...
//                    ois.readObject() as List<IkoroMessage>
//                }
//            }
//        } catch (e: Exception) {
...
//    }
//
//    private fun saveMessagesToFile(file: File, messages: List<IkoroMessage>) {
