...
import com.ikoro.android.onboarding.BluetoothCheckScreen
import com.ikoro.android.onboarding.BluetoothStatus
import com.ikoro.android.onboarding.BluetoothStatusManager
import com.ikoro.android.onboarding.BatteryOptimizationManager
import com.ikoro.android.onboarding.BatteryOptimizationPreferenceManager
import com.ikoro.android.onboarding.BatteryOptimizationScreen
import com.ikoro.android.onboarding.BatteryOptimizationStatus
import com.ikoro.android.onboarding.BackgroundLocationPermissionScreen
import com.ikoro.android.onboarding.InitializationErrorScreen
import com.ikoro.android.onboarding.InitializingScreen
import com.ikoro.android.onboarding.LocationCheckScreen
import com.ikoro.android.onboarding.LocationStatus
import com.ikoro.android.onboarding.LocationStatusManager
import com.ikoro.android.onboarding.OnboardingCoordinator
import com.ikoro.android.onboarding.OnboardingState
import com.ikoro.android.onboarding.PermissionExplanationScreen
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.ikoro.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = android.content.IntentFilter(com.ikoro.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.ikoro.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        com.ikoro.android.service.AppShutdownCoordinator.cancelPendingShutdown()
        ...
        try { com.ikoro.android.service.MeshForegroundService.start(applicationContext) } catch (_: Exception) { }
        meshService = com.ikoro.android.service.MeshServiceHolder.getOrCreate(applicationContext)
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.ikoro.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.ikoro.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.ikoro.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.ikoro.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.ikoro.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.ikoro.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.ikoro.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.ikoro.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.ikoro.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.ikoro.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.ikoro.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.ikoro.android.geohash.GeohashChannelLevel.REGION
                        else -> com.ikoro.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.ikoro.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.ikoro.android.geohash.ChannelID.Location(geohashChannel)
    ...
    private fun handleVerificationIntent(intent: Intent) {
        ...
        if (uri.scheme != "ikoro" || uri.host != "verify") return
