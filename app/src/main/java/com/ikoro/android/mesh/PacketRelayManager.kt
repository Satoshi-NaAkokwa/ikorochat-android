 ...
 * 
 * This class handles all relay decisions and logic for Ikoro packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.ikoro.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
     ...
     */
    internal fun isPacketAddressedToMe(packet: IkoroPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: IkoroPacket, fromPeerID: String): Boolean {
