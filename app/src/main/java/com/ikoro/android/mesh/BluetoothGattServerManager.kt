...
class BluetoothGattServerManager(
    ...
    fun start(): Boolean {
        ...
        try {
            if (!com.ikoro.android.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value) {
    ...
    private fun startAdvertising() {
        // Respect debug setting
        val enabled = try { com.ikoro.android.ui.debug.DebugSettingsManager.getInstance().gattServerEnabled.value } catch (_: Exception) { true }
