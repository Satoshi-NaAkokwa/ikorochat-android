...
class FragmentManager {
    ...
    companion object {
        ...
        private const val FRAGMENT_SIZE_THRESHOLD = com.ikoro.android.util.AppConstants.Fragmentation.FRAGMENT_SIZE_THRESHOLD // Matches iOS: if data.count > 512
        private const val MAX_FRAGMENT_SIZE = com.ikoro.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE        // Matches iOS: maxFragmentSize = 469 
        private const val FRAGMENT_TIMEOUT = com.ikoro.android.util.AppConstants.Fragmentation.FRAGMENT_TIMEOUT_MS     // Matches iOS: 30 seconds cleanup
        private const val CLEANUP_INTERVAL = com.ikoro.android.util.AppConstants.Fragmentation.CLEANUP_INTERVAL_MS     // 10 seconds cleanup check
    }
     ...
     */
    fun createFragments(packet: IkoroPacket): List<IkoroPacket> {
        try {
        ...
        val fragments = mutableListOf<IkoroPacket>()
        ...
        for (index in fragmentChunks.indices) {
            ...
            val fragmentPacket = IkoroPacket(
     ...
     */
    fun handleFragment(packet: IkoroPacket): IkoroPacket? {
        ...
        try {
            ...
            val maxFragments = com.ikoro.android.util.AppConstants.Fragmentation.MAX_FRAGMENTS_PER_ID
            ...
            synchronized(fragmentStateLock) {
                ...
                if (isNewSet) {
                    val maxActive = com.ikoro.android.util.AppConstants.Fragmentation.MAX_ACTIVE_FRAGMENT_SETS
                ...
                val maxTotalBytes = com.ikoro.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_TOTAL_BYTES
                ...
                val maxGlobalBytes = com.ikoro.android.util.AppConstants.Fragmentation.MAX_GLOBAL_FRAGMENT_TOTAL_BYTES
                ...
                if (fragmentMap.size == expectedTotal) {
                    ...
                    val originalPacket = IkoroPacket.fromBinaryData(reassembledData.toByteArray())
...
interface FragmentManagerDelegate {
    fun onPacketReassembled(packet: IkoroPacket)
}
