package com.ikoro.android.noise

import android.content.Context
import android.util.Log
import com.ikoro.android.identity.SecureIdentityStateManager
import com.ikoro.android.mesh.PeerFingerprintManager
import com.ikoro.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.ikoro.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.ikoro.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.ikoro.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a IkoroPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.ikoro.android.protocol.IkoroPacket): com.ikoro.android.protocol.IkoroPacket? {
    ...
    /**
     * Verify a IkoroPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.ikoro.android.protocol.IkoroPacket, publicKey: ByteArray): Boolean {
