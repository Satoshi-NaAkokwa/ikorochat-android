...
/**
 * IkoroChat-over-Nostr Adapter
 * Direct port from iOS implementation for 100% compatibility
 */
object NostrEmbeddedIkoroChat {
    
    private const val TAG = "NostrEmbeddedIkoroChat"
    
    /**
     * Build a `ikoro1:` base64url-encoded IkoroChat packet carrying a private message for Nostr DMs.
     */
    fun encodePMForNostr(
        ...
        try {
            ...
            return "ikoro1:" + base64URLEncode(data)
        } catch (e: Exception) {
    ...
    /**
     * Build a `ikoro1:` base64url-encoded IkoroChat packet carrying a delivery/read ack for Nostr DMs.
     */
    ...
    /**
     * Build a `ikoro1:` ACK (delivered/read) without an embedded recipient peer ID (geohash DMs).
     */
    ...
    /**
     * Build a `ikoro1:` payload without an embedded recipient peer ID (used for geohash DMs).
     */
