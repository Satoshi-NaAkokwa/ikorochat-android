package com.ikoro.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.ikoro.android.model.IkoroFilePacket
    ): String {
    ...
    /**
     * Classify IkoroMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.ikoro.android.model.IkoroMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.ikoro.android.model.IkoroMessageType.Image
            lower.startsWith("audio/") -> com.ikoro.android.model.IkoroMessageType.Audio
            else -> com.ikoro.android.model.IkoroMessageType.File
        }
    }
