...
@Parcelize
enum class IkoroMessageType : Parcelable {
    Message,
    Audio,
    Image,
    File
...
/**
 * IkoroMessage - 100% compatible with iOS version
 */
@Parcelize
data class IkoroMessage(
    val id: String = UUID.randomUUID().toString().uppercase(),
    val sender: String,
    val content: String,
    val type: IkoroMessageType = IkoroMessageType.Message,
    val timestamp: Date,
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): IkoroMessage? {
            try {
