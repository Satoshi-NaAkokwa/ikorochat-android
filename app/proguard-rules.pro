...
-keep class com.ikoro.android.protocol.** { *; }
-keep class com.ikoro.android.crypto.** { *; }
-dontwarn org.bouncycastle.**
-keep class org.bouncycastle.** { *; }

# Keep SecureIdentityStateManager from being obfuscated to prevent reflection issues
-keep class com.ikoro.android.identity.SecureIdentityStateManager {
    private android.content.SharedPreferences prefs;
    *;
}

# Keep all classes that might use reflection
-keep class com.ikoro.android.favorites.** { *; }
-keep class com.ikoro.android.nostr.** { *; }
-keep class com.ikoro.android.identity.** { *; }

# Keep Tor implementation (always included)
-keep class com.ikoro.android.net.RealTorProvider { *; }
